public class GPGSV {
    private static String str1="$GPGSV,2,1,08,01,40,083,46,02,17,308,41,12,07,344,39,14,22,228,45*75";
    public GPGSV() {
        System.out.println(str1);
        str1=str1.replaceAll("\\,|\\$|\\*"," "); // удаление пробелов
        str1 = str1.trim(); //удаление 1 и последнего пробела

        String[] res1 = str1.split(" "); // выделение значения после пробела
        String name=res1[0];;
